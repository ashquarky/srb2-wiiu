...
//#endif
#if defined (_WIN32) || (defined (__unix__) && !defined (MSDOS)) || defined(__APPLE__) || defined (UNIXCOMMON) || defined (macintosh) || defined(__WIIU__)
...
//wiiu: this overflows a buffer *somewhere*, so until ASAN is a thing it's off
#ifndef __WIIU__
